...
public class Contact extends com.sforce.soap.enterprise.sobject.SObject {
  ...
  private Double Age__c;

  public Double getAge__c() {
    return this.Age__c;
  }

  public void setAge__c(Double Age__c) {
    this.Age__c = Age__c;
    this.Age__c__is_set = true;
  }

  protected void setAge__c(XmlInputStream __in, TypeMapper __typeMapper) throws IOException, ConnectionException {
    __in.peekTag();
    if (__typeMapper.isElement(__in, this._lookupTypeInfo("Age__c", "urn:sobject.enterprise.soap.sforce.com", "Age__c", "http://www.w3.org/2001/XMLSchema", "double", 0, 1, true))) {
      this.setAge__c((Double)__typeMapper.readObject(__in, this._lookupTypeInfo("Age__c", "urn:sobject.enterprise.soap.sforce.com", "Age__c", "http://www.w3.org/2001/XMLSchema", "double", 0, 1, true), Double.class));
    }
  ...
  private Boolean Email_Opt_Out__c;

  public Boolean getEmail_Opt_Out__c() {
    return this.Email_Opt_Out__c;
  }

  public void setEmail_Opt_Out__c(Boolean Email_Opt_Out__c) {
    this.Email_Opt_Out__c = Email_Opt_Out__c;
    this.Email_Opt_Out__c__is_set = true;
  }

  protected void setEmail_Opt_Out__c(XmlInputStream __in, TypeMapper __typeMapper) throws IOException, ConnectionException {
    __in.peekTag();
    if (__typeMapper.isElement(__in, this._lookupTypeInfo("Email_Opt_Out__c", "urn:sobject.enterprise.soap.sforce.com", "Email_Opt_Out__c", "http://www.w3.org/2001/XMLSchema", "boolean", 0, 1, true))) {
      this.setEmail_Opt_Out__c((Boolean)__typeMapper.readObject(__in, this._lookupTypeInfo("Email_Opt_Out__c", "urn:sobject.enterprise.soap.sforce.com", "Email_Opt_Out__c", "http://www.w3.org/2001/XMLSchema", "boolean", 0, 1, true), Boolean.class));
    }

  }

  private void writeFieldEmail_Opt_Out__c(XmlOutputStream __out, TypeMapper __typeMapper) throws IOException {
    __typeMapper.writeObject(__out, this._lookupTypeInfo("Email_Opt_Out__c", "urn:sobject.enterprise.soap.sforce.com", "Email_Opt_Out__c", "http://www.w3.org/2001/XMLSchema", "boolean", 0, 1, true), this.Email_Opt_Out__c, this.Email_Opt_Out__c__is_set);
  }
